(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://willcrichton.net/wiki/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://willcrichton.net/wiki/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://willcrichton.net/wiki/assets/css/just-the-docs-' + theme + ".css"
      );
    };
