...
2. **How can we compare the different notations and mechanisms of document languages?** For example, what would a [7<abbr>GUI</abbr>s][7guis] or [Rosetta Code] or [Todo<abbr>MVC</abbr>][todomvc] look like for documents? Can we more rigorously compare new document language designs on what documents they make *possible* or *easy*?
